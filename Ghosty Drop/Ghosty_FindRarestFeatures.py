...
all_jsons = pd.DataFrame(columns = ['Name','Frames', 'Body', 'Eyes','Head', 'Accessories','Mouth'])
...
ghosty_dummies = pd.get_dummies(all_jsons, columns = ['Frames', 'Body', 'Eyes','Head', 'Accessories','Mouth'])
...
# Export to CSV
all_ghosts_ranked.to_csv('GhostyDrop_FeatureRanks.csv')
